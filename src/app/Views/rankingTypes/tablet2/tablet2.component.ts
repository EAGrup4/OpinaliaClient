...
@Component({
  moduleId: module.id,
  selector: 'app-ranking-tablet',
  templateUrl: './tablet2.component.html',
  styleUrls: ['./tablet2.component.css'],
  providers: [ProductService]
})

export class RankingTabletComponent implements OnInit {
  product: any;
  ...
  ngOnInit() {
    this.productService.getBest7TypeProducts('tablet').subscribe(
      (data) => {
        this.product = data;
        console.log(data);
      });
