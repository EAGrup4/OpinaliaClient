...
@Component({
  moduleId: module.id,
  selector: 'app-ranking-laptop',
  templateUrl: './laptop2.component.html',
  styleUrls: ['./laptop2.component.css'],
  providers: [ProductService]
})

export class RankingLaptopComponent implements OnInit {
  product: any;
  ...
  ngOnInit() {
    this.productService.getBestTypeProducts('Portatil').subscribe(
      (data) => {
        this.product = data;
        console.log(data);
      });
