...
@Component({
  moduleId: module.id,
  selector: 'app-companies-lg',
  templateUrl: './lg.component.html',
  styleUrls: ['./lg.component.css'],
  providers: [ProductService]
})
export class CompaniesLgComponent implements OnInit {
  ...
  ngOnInit() {
    this.productService.searchProductByCompany('Lg').subscribe(
      (data) => {
        this.product = data;
        console.log(data);
      });
  ...
  puntuation() {
    this.productService.getBestCompanyProducts('Lg').subscribe(
      (data) => {
        this.product = data;
        console.log(data);
      });
  ...
  newest() {
    this.productService.getNewCompanyProducts('Lg').subscribe(
      (data) => {
        this.product = data;
        console.log(data);
      });
