...
@Component({
  moduleId: module.id,
  selector: 'app-companies-apple',
  templateUrl: './apple.component.html',
  styleUrls: ['./apple.component.css'],
  providers: [ProductService]
})
export class CompaniesAppleComponent implements OnInit {
  ...
  ngOnInit() {
    this.productService.searchProductByCompany('Apple').subscribe(
      (data) => {
        this.product = data;
        console.log(data);
      });
  ...
  newest() {
    this.productService.getNewCompanyProducts('Apple').subscribe(
      (data) => {
        this.product = data;
        console.log(data);
      });
